...
import dev.abysslasea.somnia.network.client.ClientWakeTimeUpdatePacket;
import dev.abysslasea.somnia.network.client.FatigueUpdatePacket;
import dev.abysslasea.somnia.network.client.OpenGUIPacket;
import dev.abysslasea.somnia.network.client.PlayerWakeUpPacket;
import dev.abysslasea.somnia.network.client.SpeedUpdatePacket;
