...
import dev.abysslasea.somnia.util.FatigueDisplayPosition;
import dev.abysslasea.somnia.util.ScreenPosition;
import dev.abysslasea.somnia.util.SideEffectStage;
import dev.abysslasea.somnia.util.SpeedColor;
...
public class ClientSleepHandler {
    ...
    private void renderFatigueTextDisplay(GuiGraphics guigraphics, double fatigue) {
        FatigueDisplayPosition pos = this.mc.player.isSleeping() ? FatigueDisplayPosition.BOTTOM_RIGHT : SomniaConfig.CLIENT.fatigueTextDisplayPos.get();
